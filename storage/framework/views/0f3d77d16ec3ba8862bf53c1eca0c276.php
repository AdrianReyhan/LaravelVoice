        ...
        <div class="container">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <form id="voiceForm" action="<?php echo e(route('registerVoice')); ?>" method="POST" enctype="multipart/form-data"
                        style="display: none;">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\voiceLaravel\resources\views/voiceEnrollment/index.blade.php ENDPATH**/ ?>